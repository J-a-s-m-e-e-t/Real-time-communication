...
import { CameraIcon,MapIcon,MapPin,ShipWheelIcon,ShuffleIcon,LoaderIcon,LogOutIcon } from 'lucide-react';
...
console.log(formState.profilePic)
  ...
  const {mutate:onboardingMutation,isPending}= useMutation({
    ...
    onSuccess:()=>{toast.success("Profile onboarded successfully");
